...
# Original source:
# https://github.com/SlinkyProject/containers/blob/ce5411bd36159a5998b67c784005556a5b6927bd/schedmd/slurm/25.05/ubuntu24.04/files/slurmd/usr/local/bin/entrypoint.sh
#
# Modifications made to the original file:
# - Added a trap to cleanup subprocesses generated by the slurmd daemon when reconfiguring.
# - Replaced invoking supervisord with directly invoking slurmd.
